"""Deprecated flat-module shim for ``kbutillib.annotator_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.genome.annotator_utils``. This shim
exists only so that old ``from kbutillib.annotator_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.genome.annotator_utils import ...
...
_warnings.warn(
    "kbutillib.annotator_utils is deprecated; import from kbutillib.domains.genome.annotator_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.genome.annotator_utils import *  # noqa: E402,F401,F403
