"""Deprecated flat-module shim for ``kbutillib.base_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.core.base_utils``. This shim
exists only so that old ``from kbutillib.base_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.core.base_utils import ...
...
_warnings.warn(
    "kbutillib.base_utils is deprecated; import from kbutillib.core.base_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.core.base_utils import *  # noqa: E402,F401,F403
