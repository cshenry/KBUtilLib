...
def emit_king_workflow(
    ...
    tsv_headers = ["operator", "ec_hint", "confidence", "method", "reaction_id", "backend"]
    ...
    # ------------------------------------------------------------------ #
    # 5. prompt.md   (KING coscientist prompt, skill.md voice)
    # ------------------------------------------------------------------ #
    ...
    prompt_content = (
        "# verAB O-Demethylation Rule Discovery — KING Coscientist Prompt\n\n"
        ...
        "| `manifest.json` | Run provenance (version, git SHA, timestamps) |\n\n"
        "---\n\n"
        "## Boundaries\n\n"
