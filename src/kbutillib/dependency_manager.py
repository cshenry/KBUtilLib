"""Deprecated flat-module shim for ``kbutillib.dependency_manager``.
...
The ``domains/`` reorg moved this module to ``kbutillib.core.dependency_manager``. This shim
exists only so that old ``from kbutillib.dependency_manager import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.core.dependency_manager import ...
...
_warnings.warn(
    "kbutillib.dependency_manager is deprecated; import from kbutillib.core.dependency_manager instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.core.dependency_manager import *  # noqa: E402,F401,F403
