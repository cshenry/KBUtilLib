...
Mirrors :class:`~kbutillib.domains.ai.argo_utils.ArgoUtils`'s submit-then-poll shape and
:class:`~kbutillib.domains.kbase.kb_berdl_utils.KBBERDLUtils`'s config-driven-endpoint /
