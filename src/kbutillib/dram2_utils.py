"""Deprecated flat-module shim for ``kbutillib.dram2_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.genome.annotation.dram2_utils``. This shim
exists only so that old ``from kbutillib.dram2_utils import ...`` call sites keep
...
_warnings.warn(
    "kbutillib.dram2_utils is deprecated; import from kbutillib.domains.genome.annotation.dram2_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.genome.annotation.dram2_utils import *  # noqa: E402,F401,F403
