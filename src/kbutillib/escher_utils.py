"""Deprecated flat-module shim for ``kbutillib.escher_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.notebook.escher_utils``. This shim
exists only so that old ``from kbutillib.escher_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.notebook.escher_utils import ...
...
_warnings.warn(
    "kbutillib.escher_utils is deprecated; import from kbutillib.domains.notebook.escher_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.notebook.escher_utils import *  # noqa: E402,F401,F403
