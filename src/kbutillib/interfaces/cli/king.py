...
def _bundle_dir() -> Path:
    ...
    File moved from cli/ → interfaces/cli/ (WP17); parent.parent.parent now
    resolves to the kbutillib package root (interfaces/cli → interfaces → kbutillib).
    """
    return Path(__file__).resolve().parent.parent.parent / "king_app"
