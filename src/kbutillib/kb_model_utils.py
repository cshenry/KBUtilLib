"""Deprecated flat-module shim for ``kbutillib.kb_model_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.modeling.kb_model_utils``. This shim
exists only so that old ``from kbutillib.kb_model_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.modeling.kb_model_utils import ...
...
_warnings.warn(
    "kbutillib.kb_model_utils is deprecated; import from kbutillib.domains.modeling.kb_model_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.modeling.kb_model_utils import *  # noqa: E402,F401,F403
