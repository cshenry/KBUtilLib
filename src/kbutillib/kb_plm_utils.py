"""Deprecated flat-module shim for ``kbutillib.kb_plm_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.ai.kb_plm_utils``. This shim
exists only so that old ``from kbutillib.kb_plm_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.ai.kb_plm_utils import ...
...
_warnings.warn(
    "kbutillib.kb_plm_utils is deprecated; import from kbutillib.domains.ai.kb_plm_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.ai.kb_plm_utils import *  # noqa: E402,F401,F403
