"""Deprecated flat-module shim for ``kbutillib.kbase_endpoints``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.kbase.kbase_endpoints``. This shim
exists only so that old ``from kbutillib.kbase_endpoints import ...`` call sites keep
...
_warnings.warn(
    "kbutillib.kbase_endpoints is deprecated; import from kbutillib.domains.kbase.kbase_endpoints instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.kbase.kbase_endpoints import *  # noqa: E402,F401,F403
