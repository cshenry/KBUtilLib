"""Deprecated flat-module shim for ``kbutillib.king_install``.
...
The ``domains/`` reorg moved this module to ``kbutillib.agents.kind_install``. This shim
exists only so that old ``from kbutillib.king_install import ...`` call sites keep
...
_warnings.warn(
    "kbutillib.king_install is deprecated; import from kbutillib.agents.kind_install instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.agents.kind_install import *  # noqa: E402,F401,F403
