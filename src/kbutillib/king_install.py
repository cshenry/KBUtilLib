...
The ``domains/`` reorg moved this module to ``kbutillib.agents.king_install``. This shim
...
_warnings.warn(
    "kbutillib.king_install is deprecated; import from kbutillib.agents.king_install instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.agents.king_install import *  # noqa: E402,F401,F403
