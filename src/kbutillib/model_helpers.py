"""Deprecated flat-module shim for ``kbutillib.model_helpers``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.modeling.model_helpers``. This shim
exists only so that old ``from kbutillib.model_helpers import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.modeling.model_helpers import ...
...
_warnings.warn(
    "kbutillib.model_helpers is deprecated; import from kbutillib.domains.modeling.model_helpers instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.modeling.model_helpers import *  # noqa: E402,F401,F403
