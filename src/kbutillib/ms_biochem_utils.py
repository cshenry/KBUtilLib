"""Deprecated flat-module shim for ``kbutillib.ms_biochem_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.biochem.ms_biochem_utils``. This shim
exists only so that old ``from kbutillib.ms_biochem_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.biochem.ms_biochem_utils import ...
...
_warnings.warn(
    "kbutillib.ms_biochem_utils is deprecated; import from kbutillib.domains.biochem.ms_biochem_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.biochem.ms_biochem_utils import *  # noqa: E402,F401,F403
