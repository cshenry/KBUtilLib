"""Deprecated flat-module shim for ``kbutillib.ms_fba_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.modeling.ms_fba_utils``. This shim
exists only so that old ``from kbutillib.ms_fba_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.modeling.ms_fba_utils import ...
...
_warnings.warn(
    "kbutillib.ms_fba_utils is deprecated; import from kbutillib.domains.modeling.ms_fba_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.modeling.ms_fba_utils import *  # noqa: E402,F401,F403
