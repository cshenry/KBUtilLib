"""Deprecated flat-module shim for ``kbutillib.rcsb_pdb_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.external.rcsb_pdb_utils``. This shim
exists only so that old ``from kbutillib.rcsb_pdb_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.external.rcsb_pdb_utils import ...
...
_warnings.warn(
    "kbutillib.rcsb_pdb_utils is deprecated; import from kbutillib.domains.external.rcsb_pdb_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.external.rcsb_pdb_utils import *  # noqa: E402,F401,F403
