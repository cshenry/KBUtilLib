"""Deprecated flat-module shim for ``kbutillib.shared_env_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.core.shared_env_utils``. This shim
exists only so that old ``from kbutillib.shared_env_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.core.shared_env_utils import ...
...
_warnings.warn(
    "kbutillib.shared_env_utils is deprecated; import from kbutillib.core.shared_env_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.core.shared_env_utils import *  # noqa: E402,F401,F403
