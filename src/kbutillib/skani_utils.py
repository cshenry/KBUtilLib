"""Deprecated flat-module shim for ``kbutillib.skani_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.genome.skani_utils``. This shim
exists only so that old ``from kbutillib.skani_utils import ...`` call sites keep
...
ones at the new location. Update your import to::
    ...
    from kbutillib.domains.genome.skani_utils import ...
...
_warnings.warn(
    "kbutillib.skani_utils is deprecated; import from kbutillib.domains.genome.skani_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.genome.skani_utils import *  # noqa: E402,F401,F403
