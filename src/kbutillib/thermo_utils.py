"""Deprecated flat-module shim for ``kbutillib.thermo_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.thermo.thermo_utils``. This shim
exists only so that old ``from kbutillib.thermo_utils import ...`` call sites keep
...
_warnings.warn(
    "kbutillib.thermo_utils is deprecated; import from kbutillib.domains.thermo.thermo_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.thermo.thermo_utils import *  # noqa: E402,F401,F403
