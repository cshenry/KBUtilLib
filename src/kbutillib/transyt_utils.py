"""Deprecated flat-module shim for ``kbutillib.transyt_utils``.
...
The ``domains/`` reorg moved this module to ``kbutillib.domains.genome.annotation.transyt_utils``. This shim
exists only so that old ``from kbutillib.transyt_utils import ...`` call sites keep
...
_warnings.warn(
    "kbutillib.transyt_utils is deprecated; import from kbutillib.domains.genome.annotation.transyt_utils instead. "
    "This flat shim will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from kbutillib.domains.genome.annotation.transyt_utils import *  # noqa: E402,F401,F403
